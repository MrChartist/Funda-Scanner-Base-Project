...
export function getMockCompanyIntelligence(symbol: string) {
  ...
  return {
    company: {
      ...
      about: `${company.name} is one of India's leading companies in the ${company.sector} sector. The company has shown consistent growth over the years and maintains a strong market position in its industry.`,
      pros: [
